...
- [ ] T8b — alinear CLAUDE.md, `config.yaml`, roadmap §0.2 y README con los hallazgos de T8 (Purpose en el delta, G3 `--parameter env dev`, gotchas Docker/`lean.json`, no publicar tras G3, G2/G3 sin código, regla de Scenarios, *Archive now*, rama); `openspec instructions` sin "ignoring"
