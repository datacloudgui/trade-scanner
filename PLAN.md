...
- [ ] T6/T7 — **T6 ✓** *(2026-09-23)* · `AGENTS.md` de solo lectura retirado; `run_review.sh` opcional (Codex no disponible) y apuntando a la ruta nueva; CLAUDE.md con reglas OpenSpec + modelo de ramas + disposición de la documentación + revisión por defecto `/opsx:verify` + `/code-review`
