...
for n in $(seq "$START" "$END"); do
  ...
  # Aviso si no existe el doc de la etapa (la revisión sigue, apoyada en PLAN.md/AGENTS.md).
...
los criterios de AGENTS.md. Usa $ref como definición del alcance y los criterios de \
aceptación (Done when) de esta etapa, y PLAN.md/SPECS.md como fuentes de verdad del \
diseño. Traza objetivo->codigo->test para cada criterio de la etapa, verifica la API de \
